...
export default function Footer() {
    return (
        <footer className="bg-gray-200">
                    ...
                    <div className="w-full sm:w-1/2 md:w-1/4 px-4">
                        ...
                        <div className='flex items-center space-x-4'>
                            <Link
                                ...
                                target="_blank"
                                className='flex justify-center items-center w-8 h-8 rounded-full bg-[#F3483E] hover:bg-[#c53932] duration-300'
                            >
            ...
            <div className='text-center bg-[#F3483E]'>
                <p className='text-[#fff] text-[14px] py-8'>
                    Copyright &copy; 2024 by Food Recipe | All Rights Reserved
                </p>
            </div>
        </footer>
    );
