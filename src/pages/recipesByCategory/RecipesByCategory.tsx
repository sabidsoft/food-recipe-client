...
import { useGetRecipesByCategoryQuery } from "../../redux/features/api/recipeApi/recipeApi";

export default function RecipesByCategory() {
    useTitle("Recipe By Category");
    ...
    const { data, isLoading, isError } = useGetRecipesByCategoryQuery({ category: categoryQuery as string, page: currentPage });
